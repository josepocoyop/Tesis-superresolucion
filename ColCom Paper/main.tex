...
\begin{figure*}[!t]
    ...
    \caption{Comparación de métodos sobre un fotograma representativo: entrada LR ($212\times120$, escalada por vecino más próximo), reconstrucción bicúbica $\times4$, salida de ESRGAN $\times4$ (propuesto) y referencia HR ($848\times480$). Los valores de PSNR, SSIM y LPIPS se indican sobre los dos métodos comparados; la entrada y la referencia no los llevan.}
