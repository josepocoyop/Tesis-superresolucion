...
\begin{figure*}[!t]
    ...
    \caption{Comparación de métodos sobre un fotograma representativo. Fila superior: fotogramas completos, con la región ampliada marcada en rojo (entrada LR escalada por vecino más próximo, reconstrucción bicúbica $\times4$, salida de ESRGAN $\times4$ y referencia HR). Fila inferior: esa misma región ampliada. Los valores de PSNR, SSIM y LPIPS son los promedios de los 60~fotogramas de evaluación, no los de este fotograma en particular.}
