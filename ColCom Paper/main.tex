...
\begin{figure*}[!t]
    ...
    \caption{Comparación de métodos sobre un fotograma representativo: entrada LR ($212\times120$, escalada por vecino más próximo), reconstrucción bicúbica $\times4$, salida de ESRGAN $\times4$ (propuesto) y referencia HR ($848\times480$). Los valores de PSNR, SSIM y LPIPS indicados sobre los dos métodos comparados son los promedios de los 60~fotogramas de evaluación, no los de este fotograma en particular.}
